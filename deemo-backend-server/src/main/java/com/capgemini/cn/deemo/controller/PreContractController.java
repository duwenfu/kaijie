...
public class PreContractController extends BaseController {
    ...
    @ApiOperation(value = "根据scheduleId获取所有预约人Id")
    @GetMapping("/{scheduleId}")
    public RespBean getPreContract(@PathVariable Long scheduleId) {

        PreContract preContract = preContractService.listPreContract(scheduleId);
